...
public class PracaDomowa4 {
    ...
    public static void main(String[] args) {
        ...
        StudendtsKlasa student1 = new StudendtsKlasa();
        StudendtsKlasa student2 = new StudendtsKlasa();
        StudendtsKlasa student3 = new StudendtsKlasa();
        ...
        StudendtsKlasa[] students = new StudendtsKlasa[] {student1,student2,student3};
